#!/bin/bash
# Precompute more feature chunks for streaming training.
# We already have chunks 0-3 (files 0-11). This adds chunks 4-19.
#
# Usage: sbatch --array=4-19 precompute_more.sh
#
# Each chunk processes 3 files (~300K games), producing ~14.7M samples.
# 20 chunks total = 60 files = ~6M games.
...
FILES_PER_CHUNK=3
CHUNK_ID=${SLURM_ARRAY_TASK_ID:-4}
