...
# Or set the defaults below and just `sbatch run_minimal_circuits_single.sh`.

# NOTE: SBATCH directives MUST come before any executable line, so variable
# assignments live here (below them, not above).
