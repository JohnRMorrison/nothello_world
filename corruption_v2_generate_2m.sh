#!/bin/bash
#SBATCH --job-name=rule_2m
#SBATCH --output=logs/rule_2m_%A_%a.out
#SBATCH --error=logs/rule_2m_%A_%a.err
#SBATCH --time=8:00:00
#SBATCH --mem=32G
...
OUTPUT_DIR="experiments/corruption_v2/games_2m/alpha${ALPHA_STR}"
