...
def _train_random_proj_streaming(chunk_dir, device, input_dim, hidden_dim,
    ...
    # Load eval data. Chunks are sorted by turn (~297k positions/turn x 49
    # turns). Taking the first N positions biases eval to turns 5-6; strided
    # slicing gives a uniform sample across turns at zero memory cost.
