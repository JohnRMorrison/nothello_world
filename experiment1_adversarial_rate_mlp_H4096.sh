#!/bin/bash
#SBATCH --job-name=exp1_mlp_H4096
#SBATCH --output=logs/exp1_mlp_H4096_%A_%a.out
#SBATCH --error=logs/exp1_mlp_H4096_%A_%a.err
#SBATCH --time=2:00:00
#SBATCH --mem=16G
...
python -u experiment1_adversarial_rate_mlp.py \
    ...
    --mlp-ckpt $BASE/pattern_simple_direct_H4096_playedeven.pt \
    --hidden 4096 \
    --output-dir experiment1_data_mlp_H4096 \
