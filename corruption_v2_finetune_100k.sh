#!/bin/bash
#SBATCH --job-name=rule_ft100
#SBATCH --output=logs/rule_ft100k_%A_%a.out
#SBATCH --error=logs/rule_ft100k_%A_%a.err
#SBATCH --time=4:00:00
#SBATCH --mem=32G
...
GAMES_DIR="experiments/corruption_v2/games_100k/${LABEL}"
