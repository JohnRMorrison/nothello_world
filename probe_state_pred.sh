#!/bin/bash
# ============================================================================
# Probe state predictor for real Othello board state — one job per layer
# ============================================================================
#
# Usage:
#   sbatch probe_state_pred.sh                    # probe all layers 0-8
#   sbatch --array=4-7 probe_state_pred.sh        # probe only layers 4-7
# ============================================================================
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-8
#SBATCH --output=logs/probe_sp_%A_layer%a.out
